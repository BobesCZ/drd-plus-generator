...
const getArmorsNecessaryStrengthPenalty = (bodyArmorsNecessaryStrength, helmetsNecessaryStrength, charStrength, charRace) => {
  if (
    ...
    const missingStrengthArmors = getArmorMissingStrength(bodyArmorsNecessaryStrength, charStrength, charRace);

    const missingStrengthHelmets = getArmorMissingStrength(helmetsNecessaryStrength, charStrength, charRace);
